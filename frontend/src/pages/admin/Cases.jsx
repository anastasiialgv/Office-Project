...
const API_BASE = "https://office-project-production-80ea.up.railway.app/office/admin";
    ...
    const fetchData = async () => {
        try {
            ...
            const [casesRes, driversRes, carsRes, empRes] = await Promise.all([
                ...
                axios.get(`https://office-project-production-80ea.up.railway.app/office/drivers/short`, config),
